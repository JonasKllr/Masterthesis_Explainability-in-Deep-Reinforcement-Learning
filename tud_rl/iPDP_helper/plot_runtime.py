...
# data_to_plot_ale = [df_ale["Training 1"], df_ale["Training 2"], df_ale["Training 3"]]
# data_to_plot_pdp = [df_pdp["Training 1"], df_pdp["Training 2"], df_pdp["Training 3"]]
# data_to_plot_shap = [df_shap["Training 1"], df_shap["Training 2"], df_shap["Training 3"]]
...
# ale_plot = plt.boxplot(data_to_plot_ale, showfliers=False, positions=[0.5, 1, 1.5], widths=0.4)
# pdp_plot = plt.boxplot(data_to_plot_pdp, showfliers=False, positions=[2.5, 3, 3.5], widths=0.4)
# shap_plot = plt.boxplot(data_to_plot_shap, showfliers=False, positions=[4.5, 5, 5.5], widths=0.4)

ale_plot = plt.boxplot(data_to_plot_1, showfliers=False, positions=[0.5, 2.5, 4.5], widths=0.4)
pdp_plot = plt.boxplot(data_to_plot_2, showfliers=False, positions=[1, 3, 5], widths=0.4)
shap_plot = plt.boxplot(data_to_plot_3, showfliers=False, positions=[1.5, 3.5, 5.5], widths=0.4)
